...
### 1.发现一个超级强大的file manager，类似于web虚拟桌面
...
### 2.发现pandas中的dataframe和series有plot方法，可以直接画表格或者line、bar等图!!!!!
...
- gitlab本身具有项目流程管理、创建合并分支、分配任务(Bug)的功能
  - http://106.13.70.248/zjz/zjz_test/issues/1发现gitlab有分配任务，合并reques的功能，可以新建分支、合并分支
- gitlab自带wiki部分http://106.13.70.248/zjz/zjz_test/wikis/home

### [Ubuntu搭建gitlab汉化](https://www.cnblogs.com/yitianyouyitian/p/9214940.html#_label1_1)不同于上面的docker中直接搭建汉化版的gitlab

`git clone http://ip_address/zjz/zjz_test.git`
